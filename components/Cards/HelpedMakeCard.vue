<template>
  <a :href="helpedMake.metadata.url" target="`_blank" rel="noreferrer">
    <button
      class="text-left border border-neutral-100 dark:border-neutral-900 hover:shadow-lg hover:bg-neutral-50 dark:hover:bg-neutral-800 transition ease-in-out duration-300 rounded-xl w-full focus:outline-none focus:ring-2 focus:ring-white"
    >
      <div class="p-4">
