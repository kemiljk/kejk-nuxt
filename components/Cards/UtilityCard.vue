<template>
  ...
  <div v-else>
    <nuxt-link :to="utility.metadata.to" rel="noreferrer" cursor="pointer">
      <button
        class="bg-neutral-100 dark:bg-neutral-900 hover:shadow-lg hover:bg-neutral-50 dark:hover:bg-neutral-800   transition ease-in-out duration-300 rounded-3xl text-left w-full focus:outline-none focus:ring-2 focus:ring-white"
      >
        <div class="p-4">
