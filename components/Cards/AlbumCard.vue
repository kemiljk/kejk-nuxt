<template>
  <a
    ...
    cursor="pointer"
  >
    <button class="bg-gray-50 dark:bg-gray-900 hover:shadow-lg hover:bg-gray-50 dark:hover:bg-gray-800   transition ease-in-out duration-300 rounded-xl w-full text-left focus:outline-none focus:ring-2 focus:ring-white">
      <div class="px-4 py-4">
