<template>
  <a
    ...
    target="`_blank"
    rel="noreferrer"
    class="w-full rounded-3xl border border-neutral-200 p-4 text-left transition duration-300 ease-out hover:bg-neutral-50 hover:shadow-lg  dark:border-neutral-800 dark:hover:bg-neutral-900 no-underline cursor-pointer select-none"
  >
