...
<div
  ...
  >
    <button
      class="bg-gray-100 dark:bg-gray-900 hover:shadow-lg hover:bg-gray-50 dark:hover:bg-gray-800 transform hover:-rotate-2 transition ease-in-out duration-300 rounded-lg text-left w-40 sm:w-full focus:outline-none focus:ring-2 focus:ring-white"
    >
      <div class="px-4 py-4">
