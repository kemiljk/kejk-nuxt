<template>
  ...
  >
    ...
    >
      ...
      <p class="font-mono text-gray-500 dark:text-gray-400 hover:px-4 focused:px-4 pt-0 pb-2 font-medium">
        {{ link.metadata.published | moment("from", "now") }}
      </p>
      <p
        class="text-gray-700 dark:text-gray-300 hover:px-4 focused:px-4 pb-4 font-medium mb-0"
