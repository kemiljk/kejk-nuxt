  ...
  computed: {
    colorClasses() {
      return {
        ...
        grey:
          "bg-neutral-200 dark:bg-neutral-800 hover:bg-neutral-400 dark:hover:bg-neutral-600 text-neutral-800 dark:text-white",
        white:
          "bg-black hover:bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 dark:hover:bg-neutral-100",
      }[this.color];
    },
  },
};
