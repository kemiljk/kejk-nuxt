<template>
<div class="justify-center bg-white dark:bg-black sm:pt-0 border-2 border-gray-100 dark:border-gray-900 rounded-xl">
            ...
            <div class="overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 sm:mr-2 bg-gray-100 dark:bg-gray-900 rounded-lg sm:rounded-tr-none sm:rounded-bl-lg">
                        ...
                        <p class="text-medium text-lg sm:text-xl font-medium text-gray-500 dark:text-gray-400 mt-2">
