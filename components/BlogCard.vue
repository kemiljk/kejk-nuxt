<template>
  <NuxtLink :to="`/thoughts/${blog.slug}`" class="cursor-pointer">
    ...
    >
      ...
      <div class="pl-4">
      <span class="w-max text-green-700 dark:text-green-400 border-2 border-green-700 dark:border-green-400 rounded-full px-3 py-1 text-xs mr-2" v-show="blog.slug.slice(0,1)">New</span>
