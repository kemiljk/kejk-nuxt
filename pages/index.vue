<template>
  <div class="relative mx-auto">
    ...
    <div class="max-w-5xl mx-auto px-4">
      ...
      <NuxtLink to="/thoughts" class="flex flex-row justify-start w-min mt-2 text-black bg-transparent hover:bg-gray-1-0 dark:hover:bg-gray-800 dark:text-white dark:bg-transparent rounded-xl px-6 py-3">
        See all
