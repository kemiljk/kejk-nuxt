<template>
  <div class="relative mx-auto">
    ...
    <div class="max-w-5xl mx-auto px-4">
      ...
      <NuxtLink to="/thoughts" class="flex flex-row justify-start w-max mt-4 text-black bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 border-2 border-black dark:border-white dark:text-white dark:bg-transparent rounded-xl px-4 py-2">
        See all
