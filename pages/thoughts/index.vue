    ...
    <div class="max-w-3xl mx-auto px-4">
      ...
      >
        <button
          ...
          class="block font-medium rounded-md bg-gray-100 dark:bg-gray-800 px-4 py-2 text-gray-600 hover:text-gray-800 active:text-gray-800 dark:text-gray-400 dark:hover:text-gray-50 dark:active:text-gray-50 hover:bg-gray-200 dark:hover:bg-gray-800 active:bg-gray-200 dark:active:bg-gray-800"
          :class="[
            {
              'text-gray-800 dark:text-gray-50 bg-gray-200 dark:bg-gray-700': selected === tab, active: selected === tab,
            },
          ]"
        >
          {{ tab }}
